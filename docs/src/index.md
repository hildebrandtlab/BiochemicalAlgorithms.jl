...
```@raw html
<img src="assets/logo.png" alt="BiochemicalAlgorithms logo" width="200" style="float: right; margin-left: 1rem; margin-right: 1rem;">
```
...
If the previous section whetted your appetite, have a look at our [tutorials](@ref "Welcome to BiochemicalAlgorithms.jl") to get started.
...
## Citing
If you use BiochemicalAlgorithms.jl in your research, please cite the following publication:
