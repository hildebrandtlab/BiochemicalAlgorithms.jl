@testitem "PubChem" begin
    ...
    @test mol.name == ball_data_path("../test/data/aspirin_pug.json_2244")
    ...
    sys2 = load_pubchem_json(ball_data_path("../test/data/aspirin_pug_bonds.json"))
